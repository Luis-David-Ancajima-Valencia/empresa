        ...
        <?php foreach ($empleados as $empleado) : ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-url="<?= base_url('empleados/delete/' . $empleado['id']); ?>">Eliminar</button>
                </td>
            </tr>
        <?php endforeach; ?>
